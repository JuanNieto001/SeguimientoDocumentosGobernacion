...
@role('admin')
<p class="sidebar-section">Administraci�n</p>
...
{!! sideLink(route('tracking.index'),'Rastreo de documentos','<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/>',$r->routeIs('tracking.*')) !!}

<p class="sidebar-section">Bandeja por �rea</p>
...
{!! sideLink(url('/planeacion'),'Planeaci�n','<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 20l-5.447-2.724A1 1 0 013 16.382V5.618a1 1 0 011.447-.894L9 7m0 13l6-3m-6 3V7m6 10l4.553 2.276A1 1 0 0021 18.382V7.618a1 1 0 00-.553-.894L15 4m0 13V4m0 0L9 7"/>',$r->is('planeacion*')) !!}
...
{!! sideLink(url('/juridica'),'Jur�dica','<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 6l3 1m0 0l-3 9a5.002 5.002 0 006.001 0M6 7l3 9M6 7l6-2m6 2l3-1m-3 1l-3 9a5.002 5.002 0 006.001 0M18 7l3 9m-3-9l-6-2m0-2v2m0 16V5m0 16H9m3 0h3"/>',$r->is('juridica*')) !!}
...
<p class="sidebar-section">An�lisis</p>
...
<p class="sidebar-section">Mi �rea</p>
