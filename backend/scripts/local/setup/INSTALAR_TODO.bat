...
echo └─────────────────────────────────────────────────────────────┘
call npm.cmd --prefix ..\frontend install recharts @tanstack/react-query zustand @dnd-kit/core @dnd-kit/utilities react-grid-layout nanoid --save
if errorlevel 1 (
...
mkdir "..\frontend\resources\js\modules\dashboard\components\widgets" 2>nul
mkdir "..\frontend\resources\js\modules\dashboard\hooks" 2>nul
mkdir "..\frontend\resources\js\modules\dashboard\store" 2>nul
mkdir "..\frontend\resources\js\modules\dashboard\types" 2>nul
