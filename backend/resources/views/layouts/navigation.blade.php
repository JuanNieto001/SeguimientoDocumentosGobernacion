{{-- Archivo: backend/resources/views/layouts/navigation.blade.php | Proposito: Vista documentada para mantenimiento. | @documentado-copilot 2026-04-11 --}}
@php
    $r = request();
    $user = auth()->user();
...
{!! sideLink(route('admin.sia-observa.index'),'SIA Observa','<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2zm2-4h10"/>',$r->routeIs('admin.sia-observa.*')) !!}
...
{!! sideLink(route('dashboards.motor.index'),'Dashboard','<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 3v18h18M7 15v3m4-8v8m4-4v4"/>',$r->routeIs('dashboards.motor.*')) !!}
...
@role('admin_general')
<p class="sidebar-section">Administraci&oacute;n</p>
{!! sideLink(route('admin.estiven-guides.index'),'Gu&iacute;as de Marsetiv','<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 7h8m-8 4h8m-8 4h5M5 3h14a2 2 0 012 2v14a2 2 0 01-2 2H5a2 2 0 01-2-2V5a2 2 0 012-2z"/>',$r->is('admin/estiven-guides*')) !!}
@endrole
