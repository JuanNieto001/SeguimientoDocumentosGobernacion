{{-- Archivo: backend/resources/views/backend/hacienda/index.blade.php | Proposito: Vista documentada para mantenimiento. | @documentado-copilot 2026-04-11 --}}
<x-app-layout>
    <x-slot name="header">
        <div>
            <h1 class="text-lg font-bold text-gray-900">Secretaría de Hacienda</h1>
            <p class="text-xs text-gray-400 mt-0.5">Gestión presupuestal — CDP y RP</p>
        </div>
    </x-slot>
    ...
    <div class="p-6 space-y-4">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-2xl border p-4 flex items-center gap-3" style="border-color:#e2e8f0">
                <div class="w-10 h-10 rounded-xl flex items-center justify-center shrink-0" style="background:#eff6ff">
                    <svg class="w-5 h-5" fill="none" stroke="#2563eb" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                </div>
                <div>
            ...
            <div class="bg-white rounded-2xl border p-4 flex items-center gap-3" style="border-color:#e2e8f0">
                <div class="w-10 h-10 rounded-xl flex items-center justify-center shrink-0" style="background:#fef2f2">
                    <svg class="w-5 h-5" fill="none" stroke="#dc2626" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg>
                </div>
                <div>
                    <p class="text-2xl font-bold text-gray-900">{{ $stats['rechazado'] ?? 0 }}</p>
                    <p class="text-xs text-gray-400">Rechazados</p>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl border p-4 flex items-center gap-3" style="border-color:#e2e8f0">
            ...
            <a href="{{ url('/hacienda?estado='.$val) }}"
                ...
                <table class="w-full text-sm">
                    <thead>
                        <tr style="background:#f8fafc">
                            ...
                            <th class="px-5 py-3.5 text-left text-xs font-semibold text-gray-400 uppercase tracking-wide">Etapa</th>
                    ...
                    <tbody class="divide-y" style="divide-color:#f8fafc">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-5 py-4 text-gray-600" style="max-width:18rem">
                                <span class="block truncate">{{ $p->objeto }}</span>
                            </td>
                            <td class="px-5 py-4 text-xs text-gray-500">{{ optional($p->etapaActual)->nombre ?? 'N/D' }}</td>
                            <td class="px-5 py-4">
                            ...
                            <td class="px-5 py-4">
                                <a href="{{ route('hacienda.show', $p->id) }}"
                        ...
                        <tr>
                            <td colspan="6" class="px-5 py-16 text-center">
                                ...
                                <p class="text-gray-400 text-sm">No hay procesos en la bandeja de Hacienda.</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
