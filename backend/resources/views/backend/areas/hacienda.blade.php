{{-- Archivo: backend/resources/views/backend/areas/hacienda.blade.php | Proposito: Vista documentada para mantenimiento. | @documentado-copilot 2026-04-11 --}}
<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-lg font-bold text-gray-900 leading-none">Mi Bandeja - Hacienda</h1>
                <p class="text-xs text-gray-400 mt-1">Procesos en etapa activa de Hacienda</p>
            </div>
        </div>
    </x-slot>
        ...
        <div class="grid grid-cols-1 xl:grid-cols-3 gap-5">
            ...
            <div class="xl:col-span-1 bg-white rounded-2xl overflow-hidden" style="border:1px solid #e2e8f0">
                ...
                <div class="p-3 space-y-2 max-h-[70vh] overflow-y-auto">
                    ...
                    @empty
                    <p class="text-sm text-gray-500 p-3">No hay procesos en Hacienda.</p>
                    @endforelse
                </div>
            </div>
            ...
            <div class="xl:col-span-2 bg-white rounded-2xl overflow-hidden" style="border:1px solid #e2e8f0">
                ...
                <div class="p-5 space-y-5">
                    ...
                    <div class="p-3 rounded-xl text-sm" style="background:#fffbeb;border:1px solid #fde68a;color:#92400e">
                        Este proceso aun no tiene instancia de etapa en Hacienda. Marca recibido para crearla y cargar checklist.
                    </div>
                    @endif
