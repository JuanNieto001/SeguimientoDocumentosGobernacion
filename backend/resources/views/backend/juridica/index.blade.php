{{-- Archivo: backend/resources/views/backend/juridica/index.blade.php | Proposito: Vista documentada para mantenimiento. | @documentado-copilot 2026-04-11 --}}
<x-app-layout>
    <x-slot name="header">
        <div>
            <h1 class="text-lg font-bold text-gray-900">Secretaría Jurídica</h1>
            <p class="text-xs text-gray-400 mt-0.5">Revisión legal — minutas, pólizas y contratistas</p>
        </div>
    </x-slot>
        ...
        <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
            ...
            <div class="bg-white rounded-2xl border p-4 flex items-center gap-3" style="border-color:#e2e8f0">
                <div class="w-10 h-10 rounded-xl flex items-center justify-center shrink-0" style="background:#eff6ff">
                    <svg class="w-5 h-5" fill="none" stroke="#2563eb" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"/></svg>
                </div>
                <div>
                    <p class="text-2xl font-bold text-gray-900">{{ $stats['en_curso'] ?? 0 }}</p>
                    <p class="text-xs text-gray-400">En revisión</p>
                </div>
            </div>
            <div class="bg-white rounded-2xl border p-4 flex items-center gap-3" style="border-color:#e2e8f0">
                ...
                <table class="w-full text-sm">
                    ...
                    <tbody class="divide-y" style="divide-color:#f8fafc">
                        ...
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-5 py-4">
                                <a href="{{ route('juridica.show', $p->id) }}"
                        ...
                        <tr>
                            <td colspan="6" class="px-5 py-16 text-center">
                                ...
                                <p class="text-gray-400 text-sm">No hay procesos en la bandeja de Jurídica.</p>
                            </td>
                        </tr>
                        @endforelse
                    </tbody>
