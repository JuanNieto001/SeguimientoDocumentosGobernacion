{{-- Archivo: backend/resources/views/backend/juridica/reportes.blade.php | Proposito: Vista documentada para mantenimiento. | @documentado-copilot 2026-04-11 --}}
<x-app-layout>
    <x-slot name="header">
    ...
    <div class="p-6 space-y-4">
        ...
        <div class="grid grid-cols-2 sm:grid-cols-3 gap-4">
            @foreach([
                ['Ajustados emitidos', $stats['ajustados_emitidos'] ?? 0, '#10b981'],
                ['Contratistas verificados', $stats['contratistas_verificados'] ?? 0, '#6366f1'],
                ['Pólizas aprobadas', $stats['polizas_aprobadas'] ?? 0, '#8b5cf6'],
