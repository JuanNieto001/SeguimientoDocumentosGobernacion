{{-- Archivo: backend/resources/views/backend/contract-processes/steps/step-0.blade.php | Proposito: Vista documentada para mantenimiento. | @documentado-copilot 2026-04-11 --}}
<x-app-layout>
    <x-slot name="header">
