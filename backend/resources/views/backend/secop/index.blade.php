{{-- Archivo: backend/resources/views/backend/secop/index.blade.php | Proposito: Vista documentada para mantenimiento. | @documentado-copilot 2026-04-11 --}}
<x-app-layout>
    <x-slot name="header">
        <div>
    ...
    <div class="p-6 space-y-4">
        ...
        <div class="bg-white rounded-2xl border p-4 flex items-center gap-3" style="border-color:#e2e8f0">
            ...
            @foreach(['EN_CURSO'=>'Pendientes','EN_REVISION'=>'En revisión','todos'=>'Todos'] as $val => $label)
