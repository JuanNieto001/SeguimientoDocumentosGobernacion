{{-- Archivo: backend/resources/views/backend/secop/consulta-detalle.blade.php | Proposito: Vista documentada para mantenimiento. | @documentado-copilot 2026-04-11 --}}
<x-app-layout>
    <x-slot name="header">
