{{-- Archivo: backend/resources/views/backend/admin/unidades/create.blade.php | Proposito: Vista documentada para mantenimiento. | @documentado-copilot 2026-04-11 --}}
<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h1 class="text-lg font-bold text-gray-900">Nueva Unidad</h1>
    ...
    <div class="p-6 max-w-xl">
        <form method="POST" action="{{ route('admin.unidades.store') }}" class="bg-white rounded-2xl border p-6 space-y-4" style="border-color:#e2e8f0">
            @csrf
            <div>
