{{-- Archivo: backend/resources/views/backend/admin/estiven-guides/index.blade.php | Proposito: Vista documentada para mantenimiento. | @documentado-copilot 2026-04-11 --}}
