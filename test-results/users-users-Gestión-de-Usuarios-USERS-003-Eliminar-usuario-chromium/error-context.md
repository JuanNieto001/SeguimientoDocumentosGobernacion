...
- Name: users\users.spec.js >> Gestión de Usuarios >> USERS-003: Eliminar usuario
- Location: tests\users\users.spec.js:28:3
...
Call log:
  - waiting for locator('button:has-text("Eliminar")').first()
