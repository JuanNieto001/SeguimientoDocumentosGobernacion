...
- Name: users\users.spec.js >> Gestión de Usuarios >> USERS-002: Editar usuario
- Location: tests\users\users.spec.js:20:3
...
Call log:
  - waiting for locator('a:has-text("Editar")').first()
